...
class Jcart {
    ...
    */
    public function display_cart() {
        ...
        echo tab(1) . "<form id='finalise_this_order' method='post' action='$checkout'>\n";
        echo tab(2) . "<fieldset>\n";
        echo tab(3) . "<input type='hidden' name='jcartToken' value='{$_SESSION['jcartToken']}' />\n";
        echo tab(3) . "<table id='cartbox' class='table table-bordered table-condensed table-hover'>\n";
        echo tab(4) . "<thead>\n";
        echo tab(5) . "<tr>\n";
        ...
        if($this->itemCount > 0) {
            ...
            foreach($this->get_contents() as $item) {
                ...
                echo tab(7) . "<a class='jcart-remove' href='modules/jcart/relay-post.php?jcartRemove={$item['id']}'>{$config['text']['removeLink']}</a>\n";
                echo tab(6) . "</td>\n";
                echo tab(5) . "</tr>\n";
            }
        }
        ...
        echo tab(4) . "<input type='$inputType' $src name='jcartUpdateCart' value='{$config['text']['update']}' class='jcart-button btn' />\n";
        ...
        echo tab(4) . "<input type='$inputType' $src name='jcartEmpty' value='{$config['text']['emptyButton']}' class='jcart-button btn' />\n";
        echo tab(3) . "</div>\n";
        ...
        if ($isCheckout === true) {
            ...
            echo tab(3) . "<div class='form-inline'><div class='control-group'><label class='control-label' for='buyer_name'>Name :</label><div class='controls'><input type='text' id='buyer_name' /></div></div></div>\n";
            echo tab(3) . "<div class='form-inline'><div class='control-group'><label class='control-label' for='buyer_email'>Email :</label><div class='controls'><input type='text' id='buyer_email' /></div></div></div>\n";
            echo tab(3) . "<div class='form-inline'><div class='control-group'><label class='control-label' for='buyer_phone'>Phone Number :</label><div class='controls'><input type='text' id='buyer_phone' /></div></div></div>\n";
            echo tab(3) . "<a id='processmyorder' href='' class='btn btn-success'><i class='icon-share'> </i> | Process My Order &rarr;</a>\n";
        }

        echo tab(2) . "</fieldset>\n";
        echo tab(1) . "</form>\n\n";
        
        //echo tab(1) . "<div id='jcart-tooltip' class='alert-warning' style='position:absolute;top:42px;right:0'></div>\n";
    }
}
